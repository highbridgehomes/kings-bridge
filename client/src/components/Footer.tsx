              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="flex-1 text-gray-200">
                      Front Desk: (+234) 815 288 6219, <br /> (+234) 813 395
                      6332
                    </span>
                  </a>
                </li>
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 text-gray-200 not-italic">
                    Head Office Address: KM 34 A&M PLAZA, BESIDE MOBIL FILLING
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="mt-4 text-sm text-gray-200 sm:order-first sm:mt-0">
              For questions and concerns, email us at info@kingsbridge.com
            </p>
            <ul className="flex justify-center my-4 sm:my-0 gap-6 sm:justify-start md:gap-8">
              <li>
                <a
                  href="https://web.facebook.com/highbridgeltd"
                  rel="noreferrer"
                  target="_blank"
                  className="text-white transition hover:text-gray-200"
                >
              ...
              <li>
                <a
                  href="https://www.instagram.com/highbridge_homesltd/"
                  rel="noreferrer"
                  target="_blank"
                  className="text-white transition hover:text-gray-200"
                >
              ...
              <li>
                <a
                  href="https://x.com/Highbridge_ltd"
                  rel="noreferrer"
                  target="_blank"
                  className="text-white transition hover:text-gray-200"
                >
              ...
              <li>
                <a
                  href="https://www.youtube.com/@highbridgetv5660"
                  rel="noreferrer"
                  target="_blank"
                  className="text-white transition hover:text-gray-200"
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M23.498 6.186a2.994 2.994 0 00-2.11-2.117C19.545 3.5 12 3.5 12 3.5s-7.545 0-9.388.569a2.994 2.994 0 00-2.11 2.117A31.3 31.3 0 000 12a31.3 31.3 0 00.502 5.814 2.994 2.994 0 002.11 2.117C4.455 20.5 12 20.5 12 20.5s7.545 0 9.388-.569a2.994 2.994 0 002.11-2.117A31.3 31.3 0 0024 12a31.3 31.3 0 00-.502-5.814zM9.75 15.02V8.98l6.5 3.02-6.5 3.02z"
                      clipRule="evenodd"
                    />
                  </svg>
                </a>
              ...
              <li>
                ...
                >
                  ...
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M12 0C5.372 0 0 5.372 0 12c0 6.627 5.372 12 12 12s12-5.373 12-12C24 5.372 18.628 0 12 0zm5.723 7.906l-1.853 8.376c-.143.644-.521.802-1.031.5l-3.1-2.289-1.497 1.443c-.17.17-.313.313-.637.313l.23-3.167 5.758-5.21c.25-.223-.055-.348-.387-.125L7.514 11.61l-2.867-.895c-.624-.194-.636-.625.13-.922l12.396-4.788c.573-.215 1.073.132.89.901z" />
                  </svg>
                </a>
              </li>
            </ul>
