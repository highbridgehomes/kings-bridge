              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="flex-1 text-gray-200">
                      Front Desk: (+234)8152886217, (+234)8152886218,
                      (+234)8152886219 (+234)8152886220, (+234)8152886221
                    </span>
                  </a>
                </li>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-gray-200">
              ...
              <a
                className="inline-block text-white mx-2 underline transition hover:text-gray-200"
                href="#"
              >
                Terms & Conditions
              </a>
            ...
            <p className="mt-4 text-sm text-gray-200 sm:order-first sm:mt-0">
              &copy; 2025 Highbridge Homes Limited.
            </p>
          </div>
        </div>
      </div>
